...
def load_retrieval_data(hf_hub_name="", method = "", model_name="", r1_mode=False):
    ...
    with open(query_path, "r", encoding="utf-8") as f:
        ...
        for line in f:
            ...
            if method != "" and model_name != "":
                if r1_mode:
                    # queries.append(e["text"]+ " " + split_response_for_r1(model_name, e["hy_doc"]))
...
r1_mode = False
# gar_method = "lamer"
# gar_llms = ["qwen-7b", "qwen-72b", "gpt4"]
# gar_llms = ["qwen-7b", "qwen-72b", "gpt4", "qwen-32b", "llama-70b", "r1-qwen-32b", "qwq-32b", "r1-llama-70b", "huatuo-o1-70b"]
gar_method = ""
gar_llms = [""]
for gar_llm in gar_llms:
    if gar_llm in r1_model_list:
        r1_mode = True
    # task_names = ["Stack-Biology"]
    task_names = ["Stack-Biology", "Stack-Bioinformatics", "Stack-Medical", "MedXpertQA-Exam", 'MedQA-Diag', "PMC-Treat", "PMCPatients", "IIYiPatients-EN"]
    ndcg_values = []
    for task_name in task_names[:]:
        ...
        if gar_method != "":
            ...
            save_path = f"./results/retrieval/bm25/{task_name}.json"
        ...
        if save_top_k:
            save_top_k_path = f"./topk_docs/BM25/{task_name}.jsonl"
